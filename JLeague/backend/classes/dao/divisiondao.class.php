...
class JLDivisionDAO extends JLBaseDAO{
	 ...
	 */
   	function insert(JLDivision $obj) {
		...
		$query = 'INSERT INTO ' .$this->getNameQuote( $this->tablename  ) . ' (id, name, season, league_id,parent_indicator, parent_divid, sort_order, properties,agegroup,primarycontactid,secondarycontactid,notes,games,published) '
			. ' VALUES (0,'
			. '"' . $obj->getName() . '",' 
			. '"' . $obj->getSeasonId() . '",'
			. '"' . $obj->getLeagueId(). '",'
