...
/**
 * The JLSecurityService is a service that performs general security related functions used within JLeague.  Currently, this class
 * is uses the Joomla JUser object.   
 * 
 * @author cs1559
 * @todo This class needs to be refactored to abstract the Joomla JUser class from the core functionality.
 */

class JLSecurityService  extends JLBaseService  {
	
	public static $registered = "Registered";
	public static $admin = "Administrator";
	public static $superadmin = "Super Administrator";
	public static $ADMINGROUP = 8;
	...
	/**
	 * This function returns the DAO object.  This is an abstract function that must be inherited by any class that extends the JLBaseService class.
	 * @see JLBaseService::getDao()
	 */
	function getDao() {
		return null;
	}
	...
	/**
	 * this function returns a current user object (if available).
	 */
	function getUser() {
		return JLApplication::getUser();
	}
	/**
...
// 		return false;
	...
	/**
	 * The isUserAssociatedWithTeam function allows you to determine if the currently logged in user is associated with ANY team in the league
	 * within the context of a given season.   
	 * 
	 * @param unknown_type $seasonid
	 * @return boolean
	 */
...
//echo $query;
	...
	/**
	 * This function isused to determine if a logged in user can edit/manage any data related to a given team profile.
	 * 
	...
	public function isUserAssociatedWithTeamById( $teamid) {
		...
		//  An administrator can edit data on ALL teams
		if (self::isAdmin()) {
			return true;
		}
