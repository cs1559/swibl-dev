...
class JLSeasonsListView extends JLListView {
	...
	function getToolbar() {
		JToolBarHelper::title( JLText::getText( 'Seasons' ), 'seasons');
	...
	{
		$coreurl = JURI::base() . "index.php?option=com_jleague&controller=seasons&task=togglePublish";
