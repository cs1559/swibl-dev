	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="myModalLabel">League Bulletins</h4>
	      </div>
	      <div class="modal-body">
				<div id="managebulletin-form">
					...
					<input type="hidden" name="task" value="doSaveNewBulletin"/>
					<input type="hidden" name="bulletinid" value="<?php isset($bulletin) ? PRINT ($bulletin->getId()) : 0; ?>"/>
					<input type="hidden" name="ownerid" value="<?php isset($bulletin) ? PRINT ($bulletin->getOwnerId()) : 0; ?>"/>
					<input type="hidden" name="teamid" value="0"/>
					<input type="hidden" name="sponsorid" value="<?php echo $sponsor->getId();?>"/>
					<input type="hidden" name="bulletin_category" value="S"/>
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn btn-primary" onClick="javascript: saveNewBulletin(document.bulletinForm.bulletinid);">Save changes</button>
	      </div>
	    </div><!-- /.modal-content -->
	  </div><!-- /.modal-dialog -->
	</div><!-- /.modal -->
	...
	<!-- Form Name -->
	<legend>Manage Your Bulletins</legend>	
	
		<div class="teamprofile-toolbar">
		
       <button type="button" class="btn btn-primary btn-xs" onClick="javascript:addNewBulletin(0,'S',<?php echo $sponsor->getId(); ?>);">Add Bulletin</button>
