...
class JLRouteMap extends fsBaseObject  {
	...
	public static $_routes = array(
			'/league/displayStandings' => array( // Default controller
					'controller' => 'standings',
					'method' => 'viewStandings',
					'number' => '',
					'param' => ''
			),
			'/league/viewTeams' => array(
					'controller' => 'teams',
					'method' => 'viewTeams',
					'number' => '',
					'param' => ''
			),
			'/league/viewTeamProfile' => array(
					'controller' => 'teams',
					'method' => 'viewTeamProfile',
					'number' => '',
					'param' => ''
			),
			'/league/viewBulletinBoard' => array(
					'controller' => 'bulletins',
					'method' => 'viewBulletinBoard',
					'number' => '',
					'param' => ''
			),
			'/league/viewTournaments' => array(
					'controller' => 'bulletins',
					'method' => 'viewCategory',
					'number' => '',
					'param' => array("catid" => 4)
			),
			'/league/profile/view/:id' => array(
					'controller' => 'teams',
					'method' => 'viewTeamProfile',
					'number' => '',
					'param' => ''
	...
	private $_routes2 = array(
					array ('path' => '/league/displayStandings' ,
					'controller' => 'standings',
					'method' => 'viewStandings',
					'number' => '',
					'param' => ''
			),
					array ('path' => '/league/viewTeams' ,
					'controller' => 'teams',
					'method' => 'viewTeams',
					'number' => '',
					'param' => ''
			),
					array ('path' => '/league/viewTeamProfile' ,
					'controller' => 'teams',
					'method' => 'viewTeamProfile',
					'number' => '',
					'param' => ''
			),
					array ('path' => '/league/viewBulletinBoard' ,
					'controller' => 'bulletins',
					'method' => 'viewBulletinBoard',
					'number' => '',
					'param' => ''
			),
					array ('path' => '/league/viewTournaments' ,
					'controller' => 'bulletins',
					'method' => 'viewCategory',
					'number' => '',
					'param' => array("catid" => 4)
