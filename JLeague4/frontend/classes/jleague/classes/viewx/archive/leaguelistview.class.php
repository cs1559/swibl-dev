...
class JLLeagueListView extends JLListView {
	...
	function getToolbar() {
		JToolBarHelper::title( JLText::getText( 'Leagues' ), 'leagues');
	...
	{
		$coreurl = JURI::base() . "index.php?option=com_jleague&controller=leagues&task=togglePublish";
