	 ...
	 */
	class mBatch  extends mBaseController {
		...
		function generateStandings() {
			...
			if ($debug) {
				$standings = $engine->generateStandings( $season->getId(),null,true);
			} else {
    		...
    		echo "Number of standings rows inserted: " . $i;
    		// Update Temp reocrds with headcoach name
    		try {
    			$dao->updateTempRecords();
    		} catch (Exception $e) {
    			throw $e;
    		}
