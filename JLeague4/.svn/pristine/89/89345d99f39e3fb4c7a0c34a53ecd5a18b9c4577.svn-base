...
<?php $ctr=1; 
	...
	foreach ($games as $game) { 
		...
		$ctr = $ctr + 1;
				$hlink = JRoute::_("index.php?option=com_jleague&controller=teams&task=viewTeamProfile&teamid=" . $game->getHometeamId() . "&Itemid=9999999");
				$vlink = JRoute::_("index.php?option=com_jleague&controller=teams&task=viewTeamProfile&teamid=" . $game->getAwayteamId() . "&Itemid=9999999");
